  ...
  const list: ToolDoc[] = [
    ...
    },
    {
      ...
      output_fields_summary: [
        ...
        { name: "meta", type: "object", notes: "{version, scoring_model_id, normalization_enabled}" },
      ],
    },
    {
      id: "report.agent_selection.v1",
      endpoint: "/api/frameworks/report.agent_selection.v1",
      methods: ["POST"],
      monetization_ready: true,
      stability_level: "experimental",
      input_fields_summary: [
        { name: "goal", type: "string", required: false },
        { name: "scenario.name", type: "string", required: false },
        { name: "scenario.weights", type: "object", required: false },
        { name: "subjects.a", type: "object", required: false, notes: "{id,label,domain?}" },
        { name: "subjects.b", type: "object", required: false, notes: "{id,label,domain?}" },
        { name: "audit.a", type: "object", required: true, notes: "Output object from site.audit.agent_ready" },
        { name: "audit.b", type: "object", required: true, notes: "Output object from site.audit.agent_ready" },
        { name: "simulation.output", type: "object", required: true, notes: "Output object from agent.selection.simulate" },
      ],
      output_fields_summary: [
        { name: "report_version", type: "string" },
        { name: "created_at", type: "null", notes: "Intentionally omitted for determinism" },
        { name: "subjects", type: "object", notes: "{winner, loser}" },
        { name: "executive_summary", type: "string[]", notes: "3-6 short bullets" },
        { name: "evidence", type: "object", notes: "{audit_summary, simulation_summary}" },
